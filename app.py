...
def main():
    ...
    if api_key:
        ...
        subject = st.text_input("Subject of the Document:")
        document_file = st.file_uploader("Upload your educational material (PDF):", type=['pdf'])
        question = st.text_input("Your Initial Question:")
